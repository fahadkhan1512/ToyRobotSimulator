...
{
    public class RobotControlProcessorTests
    {
        private readonly IRobotControlProcessor _robotControlProcessor;
        public RobotControlProcessorTests()
        {
            ...
            _robotControlProcessor = new RobotControlProcessor(parameterConvertor, commandStrategy);
        }
